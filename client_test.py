...
class ClientTest(unittest.TestCase):
  ...
  """ ------------ Add more unit tests ------------ """
  def test_getDataPoint_calculatePriceBidEqualsZero(self):
    quotes = [
  ...
  def test_getDataPoint_calculateAskEqualsZero(self):
    quotes = [
  ...
  def test_getRatio_calculatePriceRatioBidEqualsZero(self):
    quotes = [
      {'top_ask': {'price': 119.2, 'size': 36}, 'timestamp': '2019-02-11 22:06:30.572453', 'top_bid': {'price': 0, 'size': 109}, 'id': '0.109974697771', 'stock': 'ABC'},
      {'top_ask': {'price': 121.68, 'size': 4}, 'timestamp': '2019-02-11 22:06:30.572453', 'top_bid': {'price': 0, 'size': 81}, 'id': '0.109974697771', 'stock': 'DEF'}
    ]
  ...
  def test_getRatio_calculatePriceRatioAskEqualsZero(self):
    quotes = [
